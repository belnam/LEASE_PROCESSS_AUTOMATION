...
pickle_file_path_xtra_account = os.path.join(pickle_folder, "last_processed_timestamp_xtra_account.pickle")
...
try:
    ...
    desired_account_email = ws_rental_accounts['A5'].value  
...
if desired_account is not None:
    ...
    if os.path.exists(pickle_file_path_xtra_account):
        try:
            with open(pickle_file_path_xtra_account, "rb") as file:
    ...
    with open(pickle_file_path_xtra_account, "wb") as file:
