...
pickle_file_path_premier_account = os.path.join(pickle_folder, "last_processed_timestamp_premier_account.pickle")
...
try:
    ...
    desired_account_email = ws_rental_accounts['A7'].value  
...
if desired_account is not None:
    ...
    if os.path.exists(pickle_file_path_premier_account):
        try:
            with open(pickle_file_path_premier_account, "rb") as file:
    ...
    with open(pickle_file_path_premier_account, "wb") as file:
