...
pickle_file_path_bowman_account = os.path.join(pickle_folder, "last_processed_timestamp_bowman_account.pickle")
...
if desired_account is not None:
    ...
    if os.path.exists(pickle_file_path_bowman_account):
        try:
            with open(pickle_file_path_bowman_account, "rb") as file:
    ...
    with open(pickle_file_path_bowman_account, "wb") as file:
