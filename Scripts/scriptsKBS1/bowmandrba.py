...
import datetime
import getpass
def bowmandrbaprocess(pageText):
                output_list = []
                df = pd.DataFrame()
                rowDict = {"TOLL AGENCY":"DELAWARE RIVER AND BAY AUTHORITY","LP":"","LP STATE":"","TRXN DATE & TIME":"","EXIT LANE/LOCATION":"","ACCOUNT":"", "REFERENCE # ":"","VIOLATION":"","AMOUNT DUE":"","DUE DATE":"","PIN NO #":"","INVOICE #":"","CODE 1#":"","CODE 2#":"","BILL NO#":""  }
                ...
                drba = re.findall(r'DELAWARE\W+\w.*\n+&\w+TY|Delaware River and Bay Authority',pageText)
